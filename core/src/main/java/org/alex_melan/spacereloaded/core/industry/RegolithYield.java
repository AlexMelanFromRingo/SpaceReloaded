 ...
 * С 007 кислород — в килограммах (блок реголита 15 кг × 20 % = 3 кг). Металлы упрощены до гарантированной железной пыли и шанса титана
 * (ильменит FeTiO₃ морских районов).
 *
 * @param oxygen         кислород за цикл, кг
 ...
 */
public record RegolithYield(double oxygen, int ironDust, double titaniumChance, int slag) {

    /** Итог одного цикла. */
    public record Output(double oxygen, int ironDust, int titaniumDust, int slag) {
    }
