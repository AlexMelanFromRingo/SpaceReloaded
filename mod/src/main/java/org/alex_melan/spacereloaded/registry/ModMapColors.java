...
public final class ModMapColors {
    ...
    private static final Map<String, MapColor> COLORS = Map.ofEntries(
        ...
        Map.entry("asu_compressor", MapColor.STONE),
        Map.entry("asu_heat_exchanger", MapColor.WOOL),
        Map.entry("asu_sump", MapColor.TERRACOTTA_CYAN),
        Map.entry("asu_tray", MapColor.CLAY),
        ...
        Map.entry("beo_reflector", MapColor.QUARTZ),
        Map.entry("beryl_ore", MapColor.TERRACOTTA_LIGHT_BLUE),
        Map.entry("borax_ore", MapColor.COLOR_LIGHT_GRAY),
        ...
        Map.entry("cascade_controller", MapColor.STONE),
        ...
        Map.entry("control_rod_drive", MapColor.STONE),
        ...
        Map.entry("dish_mount", MapColor.METAL),
        Map.entry("dish_panel", MapColor.QUARTZ),
        Map.entry("distillation_tray", MapColor.WOOL),
        Map.entry("docking_clamp", MapColor.DEEPSLATE),
        Map.entry("dsn_controller", MapColor.QUARTZ),
        Map.entry("eaf_controller", MapColor.COLOR_GRAY),
        Map.entry("eaf_roof", MapColor.STONE),
        Map.entry("eaf_shell", MapColor.DEEPSLATE),
        Map.entry("eclss_controller", MapColor.WOOL),
        Map.entry("eclss_rack_frame", MapColor.COLOR_LIGHT_GRAY),
        ...
        Map.entry("galena_ore", MapColor.TERRACOTTA_LIGHT_BLUE),
        Map.entry("gas_centrifuge", MapColor.COLOR_LIGHT_GRAY),
        ...
        Map.entry("heat_pipe", MapColor.STONE),
        ...
        Map.entry("hyperspectral_satellite", MapColor.TERRACOTTA_LIGHT_GRAY),
        ...
        Map.entry("radiator_panel", MapColor.WOOL),
        Map.entry("reactor_core", MapColor.COLOR_GRAY),
        Map.entry("reactor_power_cap", MapColor.STONE),
        ...
        Map.entry("stirling_convertor", MapColor.COLOR_LIGHT_GRAY),
        ...
        Map.entry("uraninite_ore", MapColor.COLOR_GRAY),
