...
def main():
    # малая: Ø16 (в блоке), 8 зубьев; большая: Ø32, 16 зубьев (передаточное 2:1 — модуль общий); сетка 0.5 px
    model("rotor_small_gear", 8, 6.2, 8.0, 1.2, 0.5, 0.0, 16.0)
    model("rotor_large_gear", 16, 14.0, 16.0, 1.5, 0.5, -8.0, 24.0)
