...
OUR_BLOCK_TEX = {
    ...
    "cargo_terminal": "cargo_terminal_top", "docking_port": "docking_port_front",
    "module_hull": "module_hull", "mars_ice": "mars_ice",
    ...
    "interceptor_dish": "interceptor_dish_top", "stage_separator": "stage_separator_side",
    "mass_driver_breech": "mass_driver_breech_front", "steel_coil": "steel_coil_side",
    "superconducting_coil": "superconducting_coil_side", "capacitor": "capacitor_side",
    "mass_catcher": "mass_catcher_top", "catcher_net": "catcher_net",
    "regolith_reactor": "regolith_reactor_front_lit", "refractory_lining": "refractory_lining",
    "sintered_regolith": "sintered_regolith", "lunar_bricks": "lunar_bricks",
}
VANILLA_TEX = {
...
<div class="hero">
  ...
  <span>Герметичность 26 направлений</span><span>ISRU</span><span>Стыковка</span><span>Орбитальный удар</span><span>Jade</span><span>Топливо-жидкость</span><span>Δv по Гоману</span><span>Грузовые линии</span><span>Wet workshop</span><span>Катапульта О’Нила</span><span>Мультиблоки</span></div>
