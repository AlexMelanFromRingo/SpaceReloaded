...
- [X] T537 Визуальный проход, волна 2: модели и хитбоксы командного модуля (капсула), спутников (крылья, антенна), пушки (ствол), ЦУПа (экраны), ректенны (диполи); рабочее состояние контроллера атмосферы
